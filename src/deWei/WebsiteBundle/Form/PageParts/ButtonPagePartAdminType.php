...
namespace deWei\WebsiteBundle\Form\PageParts;

use deWei\WebsiteBundle\Entity\PageParts\ButtonPagePart;
...
class ButtonPagePartAdminType extends AbstractType
{
	...
	$resolver->setDefaults(array(
	    'data_class' => '\deWei\WebsiteBundle\Entity\PageParts\ButtonPagePart'
	));
    }
}
