...
/**
 * @ORM\Entity
 * @ORM\Table(name="dewei_websitebundle_video_page_parts")
 */
class VideoPagePart extends AbstractPagePart
{
    ...
    {
	return "deWeiWebsiteBundle:PageParts/VideoPagePart:view.html.twig";
    }
    ...
    {
	return new \deWei\WebsiteBundle\Form\PageParts\VideoPagePartAdminType();
    }
}
