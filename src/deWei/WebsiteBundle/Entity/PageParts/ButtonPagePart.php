 ...
 * ButtonPagePart
 *
 * @ORM\Table(name="dewei_websitebundle_button_page_parts")
 * @ORM\Entity
 */
class ButtonPagePart extends AbstractPagePart
{
    ...
    {
	return 'deWeiWebsiteBundle:PageParts:ButtonPagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \deWei\WebsiteBundle\Form\PageParts\ButtonPagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \deWei\WebsiteBundle\Form\PageParts\ButtonPagePartAdminType();
    }
}
