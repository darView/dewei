 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="dewei_websitebundle_image_page_parts")
 */
class ImagePagePart extends AbstractPagePart
{
    ...
    {
	return 'deWeiWebsiteBundle:PageParts:ImagePagePart/view.html.twig';
    }

    /**
     * Get the admin form type.
     *
     * @return \deWei\WebsiteBundle\Form\PageParts\ImagePagePartAdminType
     */
    public function getDefaultAdminType()
    {
	return new \deWei\WebsiteBundle\Form\PageParts\ImagePagePartAdminType();
    }
}
